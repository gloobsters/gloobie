...
public class Generator
{
    ...
    // HACK: These don't get baked in by default because nothing accesses it.
    private readonly List<string> _forceGeneratedTypes =
    [
        "TextureType",
        "BoneWeight",
    ];
    ...
    private void RunInternal(Writer w, Type root)
    {
        ...
        foreach (string type in this._forceGeneratedTypes)
        {
            this._context.TypeQueue.Enqueue(this._context.Types.First(t => t.Name == type));
        }
