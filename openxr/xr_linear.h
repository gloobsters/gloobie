// Copyright (c) 2025, Beyley Cardellio <ep1cm1n10n123@gmail.com>
...
inline static float XrVector3f_Dot(const XrVector3f* v);
inline static float XrVector3f_Length(const XrVector3f* v);
inline static float XrVector3f_LengthSq(const XrVector3f* v);
...
inline static float XrVector3f_LengthSq(const XrVector3f *v) { return v->x * v->x + v->y * v->y + v->z * v->z; }
