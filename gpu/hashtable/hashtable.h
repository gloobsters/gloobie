 ...
 *
 * Hashtables are generated by a call to GPU_CreateHashTable(). This function
 ...
 * table, (GPU_InsertIntoHashTable), looking up previously inserted data
 * (GPU_FindInHashTable), and removing data (GPU_RemoveFromHashTable and
 * GPU_ClearHashTable). Less common but still useful is the ability to
 * iterate through all the items in the table (GPU_IterateHashTable).
 *
...
#ifndef GPU_HashTable_h_
#define GPU_HashTable_h_
...
extern "C"
{
    ...
    *
    * \sa GPU_CreateHashTable
    */
   typedef struct GPU_HashTable GPU_HashTable;

   /**
    * A function pointer representing a hash table hashing callback.
    *
    * This is called by GPU_HashTable when it needs to look up a key in
    ...
    * functions for strings (GPU_HashString), generic integer IDs (GPU_HashID),
    * and generic pointers (GPU_HashPointer). Often you should use one of these
    * before writing your own.
    *
    * \param userdata what was passed as `userdata` to GPU_CreateHashTable().
    ...
    * \sa GPU_HashPointer
    */
   typedef Uint32(SDLCALL *GPU_HashCallback)(void *userdata, const void *key);

   /**
    * A function pointer representing a hash table matching callback.
    *
    * This is called by GPU_HashTable when it needs to look up a key in its
    ...
    * functions for strings (GPU_KeyMatchString), generic integer IDs
    * (GPU_KeyMatchID), and generic pointers (GPU_KeyMatchPointer). Often you
    ...
    * \sa GPU_CreateHashTable
    */
   typedef bool(SDLCALL *GPU_HashKeyMatchCallback)(void *userdata, const void *a, const void *b);

   /**
    * A function pointer representing a hash table cleanup callback.
    *
    * This is called by GPU_HashTable when removing items from the hash, or
    ...
    * \sa GPU_CreateHashTable
    */
   typedef void(SDLCALL *GPU_HashDestroyCallback)(void *userdata, const void *key, const void *value);
    ...
    * \since This datatype is available since SDL 3.4.0.
    *
    * \sa GPU_IterateHashTable
    */
   typedef bool(SDLCALL *GPU_HashTableIterateCallback)(void *userdata, const GPU_HashTable *table, const void *key, const void *value);
    ...
    *
    * - GPU_HashString and GPU_KeyMatchString for C strings.
    * - GPU_HashPointer and GPU_KeyMatchPointer for generic pointers.
    * - GPU_HashID and GPU_KeyMatchID for generic (possibly small) integers.
    *
    ...
    *
    * The returned hash table should be destroyed with GPU_DestroyHashTable()
    ...
    *
    * \sa GPU_DestroyHashTable
    */
   extern GPU_HashTable *GPU_CreateHashTable(int estimated_capacity,
                                             bool threadsafe,
    ...
    *
    * This will call the hash table's GPU_HashDestroyCallback for each item in
    ...
    * \since This function is available since SDL 3.4.0.
    */
   extern void GPU_DestroyHashTable(GPU_HashTable *table);
    ...
    *   table's GPU_HashDestroyCallback for the previous item.
    *
    ...
    * \since This function is available since SDL 3.4.0.
    */
   extern bool GPU_InsertIntoHashTable(GPU_HashTable *table, const void *key, const void *value, bool replace);
    ...
    * \since This function is available since SDL 3.4.0.
    *
    * \sa GPU_InsertIntoHashTable
    */
   extern bool GPU_FindInHashTable(const GPU_HashTable *table, const void *key, const void **value);

   /**
    * Remove an item from a hash table.
    *
    * If there is an item that matches `key`, it is removed from the table. This
    * will call the hash table's GPU_HashDestroyCallback for the item to be
    * removed.
    *
    ...
    * \since This function is available since SDL 3.4.0.
    */
   extern bool GPU_RemoveFromHashTable(GPU_HashTable *table, const void *key);
    ...
    * \since This function is available since SDL 3.4.0.
    */
   extern void GPU_ClearHashTable(GPU_HashTable *table);
    ...
    * \since This function is available since SDL 3.4.0.
    *
    * \sa GPU_ClearHashTable
    */
   extern bool GPU_HashTableEmpty(GPU_HashTable *table);
    ...
    * \since This function is available since SDL 3.4.0.
    */
   extern bool GPU_IterateHashTable(const GPU_HashTable *table, GPU_HashTableIterateCallback callback, void *userdata);

   /* Helper functions for GPU_CreateHashTable callbacks... */
    ...
    *
    * This is intended to be used as one of the callbacks to GPU_CreateHashTable,
    ...
    * \sa GPU_CreateHashTable
    */
   extern Uint32 GPU_HashPointer(void *unused, const void *key);
    ...
    * \sa GPU_CreateHashTable
    */
   extern bool GPU_KeyMatchPointer(void *unused, const void *a, const void *b);
    ...
    * \sa GPU_CreateHashTable
    */
   extern Uint32 GPU_HashString(void *unused, const void *key);
    ...
    * \sa GPU_CreateHashTable
    */
   extern bool GPU_KeyMatchString(void *unused, const void *a, const void *b);
    ...
    * \sa GPU_CreateHashTable
    */
   extern Uint32 GPU_HashID(void *unused, const void *key);
    ...
    * \sa GPU_CreateHashTable
    */
   extern bool GPU_KeyMatchID(void *unused, const void *a, const void *b);
    ...
    * \sa GPU_CreateHashTable
    */
   extern void GPU_DestroyHashKeyAndValue(void *unused, const void *key, const void *value);
    ...
    * \sa GPU_CreateHashTable
    */
   extern void GPU_DestroyHashKey(void *unused, const void *key, const void *value);
    ...
    * \sa GPU_CreateHashTable
    */
   extern void GPU_DestroyHashValue(void *unused, const void *key, const void *value);
