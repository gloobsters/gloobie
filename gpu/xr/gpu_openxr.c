...
#include "gpu_openxr.h"

#define VALIDATION_LAYER_API_NAME "XR_APILAYER_LUNARG_core_validation"

bool GPU_OPENXR_INTERNAL_ValidationLayerAvailable()
{
...
XrResult GPU_OPENXR_INTERNAL_GPUInitOpenXR(
    bool debugMode,
    ...
    XrInstancePfns **xr)
{
    ...
    bool validationLayersAvailable = GPU_OPENXR_INTERNAL_ValidationLayerAvailable();

    Uint32 userApiLayerCount = (Uint32)SDL_GetNumberProperty(props, GPU_PROP_DEVICE_CREATE_XR_LAYER_COUNT, 0);
    const char *const *userApiLayerNames = SDL_GetPointerProperty(props, GPU_PROP_DEVICE_CREATE_XR_LAYER_NAMES, NULL);

    Uint32 userExtensionCount = (Uint32)SDL_GetNumberProperty(props, GPU_PROP_DEVICE_CREATE_XR_EXTENSION_COUNT, 0);
    const char *const *userExtensionNames = SDL_GetPointerProperty(props, GPU_PROP_DEVICE_CREATE_XR_EXTENSION_NAMES, NULL);
    ...
    xrInstanceCreateInfo.applicationInfo.apiVersion = SDL_GetNumberProperty(props, GPU_PROP_DEVICE_CREATE_XR_VERSION, XR_API_VERSION_1_0);
    ...
    const char *applicationName = SDL_GetStringProperty(props, GPU_PROP_DEVICE_CREATE_XR_APPLICATION_NAME, "SDL Application");
    Uint32 applicationVersion = (Uint32)SDL_GetNumberProperty(props, GPU_PROP_DEVICE_CREATE_XR_APPLICATION_VERSION, 0);
    ...
    const char *engineName = SDL_GetStringProperty(props, GPU_PROP_DEVICE_CREATE_XR_ENGINE_NAME, "SDLGPU");
    uint32_t engineVersion = (uint32_t)SDL_GetNumberProperty(props, GPU_PROP_DEVICE_CREATE_XR_ENGINE_VERSION, SDL_VERSION);
    ...
    *xr = GPU_OPENXR_LoadInstance_Symbols(*instance);
    ...
    systemGetInfo.formFactor = (XrFormFactor)SDL_GetNumberProperty(props, GPU_PROP_DEVICE_CREATE_XR_FORM_FACTOR, XR_FORM_FACTOR_HEAD_MOUNTED_DISPLAY);
